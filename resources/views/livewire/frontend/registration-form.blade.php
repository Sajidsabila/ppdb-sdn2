                                    ...
                                    <div class="form-step" id="step1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="number_of_siblings" class="fw-bold">Jumlah
                                                        Saudara</label>
                                                    <input type="number"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="child_order" class="fw-bold">Status Dalam
                                                        Keluarga</label>
                                                    <input type="text"
                                    ...
                                    <div class="form-step" id="step2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="father_education" class="fw-bold">Pendidikan
                                                        Ayah</label>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="father_occupation" class="fw-bold">Pekerjaan
                                                        Ayah</label>
                                                    <select id="father_occupation" name="father_occupation"
                                                        ...
                                                        <option value="" selected disabled>Pilih pekerjaan ayah
                                                        </option>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="mother_education" class="fw-bold">Pendidikan
                                                        Ibu</label>
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="mother_occupation" class="fw-bold">Pekerjaan
                                                        Ibu</label>
                                            ...
                                            <div class="col-md-6">
                                                    ...
                                                    @if (is_object($pas_foto))
                                                        <div class="mt-2">
                                                            <img src="{{ $pas_foto->temporaryUrl() }}"
                                                                alt="Preview Pas Foto" class="img-fluid"
                                                                width="150">
                                                        </div>
                                                    @elseif($pas_foto)
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    @elseif(is_object($kartu_keluarga))
                                                        <iframe src="{{ $kartu_keluarga->temporaryUrl() }}"
