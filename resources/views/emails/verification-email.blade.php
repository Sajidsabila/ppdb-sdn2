...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo {{ $user->email }},</p>
            <p>Terima kasih telah mendaftar! Untuk menyelesaikan proses pendaftaran, silakan verifikasi alamat email
                Anda dengan mengklik tombol di bawah ini:</p>
            <p style="text-align: center;">
                <a href="{{ route('verification', $user->remember_token) }}" target="_blank" class="button">Verifikasi
                    Email</a>
            </p>
